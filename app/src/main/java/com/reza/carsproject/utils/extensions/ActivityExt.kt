...
private fun Activity.createToast(style: MotionToastStyle, message: String, title: String? = null){
    MotionToast.createColorToast(this,title,message,style,MotionToast.GRAVITY_BOTTOM,MotionToast.LONG_DURATION,null)
}
...
fun Activity.toastSuccess(message: String, title: String? = null) = createToast(MotionToastStyle.SUCCESS,message, title)